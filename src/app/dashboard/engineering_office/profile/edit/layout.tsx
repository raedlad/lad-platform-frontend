...
import { User, FileText, ChevronRight, Briefcase } from "lucide-react";
...
const EditProfileLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    },
    {
      ...
      href: "/dashboard/engineering_office/profile/edit/documents",
      icon: FileText,
      description: "Documents and verification",
    },
    {
      title: t("sidebar.professionalInfo"),
      href: "/dashboard/engineering_office/profile/edit/professional-info",
      icon: Briefcase,
