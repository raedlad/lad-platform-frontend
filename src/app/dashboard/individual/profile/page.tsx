...
import ProfileTabContent from "@/features/profile/components/individual/IndividualProfileTabContent";
...
export default function Page() {
  ...
  // Only two tabs for individual profile
  const profileTabs = [
    {
        ...
        <div className="relative w-full mb-8">
          <div className="flex flex-row gap-6 lg:gap-12 justify-center text-center">
            ...
            <div className="flex flex-col gap-2 items-start">
              ...
              <Link href="/dashboard/individual/profile/edit/personal-info" className="flex items-center gap-2">
                <Button
                  variant="outline"
