...
const SAMPLE_PROFILE_DATA: Profile = {
  name: "Lad User",
  email: "laduserforexample@lad.com",
};
...
export default function NavUser({
  ...
  const menuItems: MenuItem[] = [
    {
      label: "Profile",
      href: `/dashboard/${currentRole}/profile`,
        ...
        <div className="group relative">
              ...
              <div className="relative">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 p-0.5">
                  <div className="w-full h-full rounded-full overflow-hidden bg-white dark:bg-zinc-900">
                    <div className="w-full h-full bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-medium">
          ...
          >
            ...
            <DropdownMenuItem asChild>
              ...
              >
                {loading ? (
                  <Loader2 className="w-4 h-4 text-red-500 group-hover:text-red-600" />
                ) : (
