...
import { Scale, Building2, Workflow } from 'lucide-react'
    ...
    return (
        <section className="py-16 md:py-32">
            <div className="@container mx-auto max-w-5xl px-6">
                ...
                <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 
                    ...
                    *:text-center md:mt-16 dark:[--color-muted:var(--color-zinc-900)]">
                    ...
                    <Card className="group border-0 shadow-none">
                        <CardHeader className="pb-3">
                            ...
                            <h3 className="mt-6 font-medium">{t("legalConsultancy")}</h3>
                        </CardHeader>
                        <CardContent>
                            <p className="text-sm">
                                {t("legalConsultancyDescription")}
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="group border-0 shadow-none">
                        <CardHeader className="pb-3">
                            ...
                            <h3 className="mt-6 font-medium">{t("architectureEngineering")}</h3>
                        </CardHeader>
                        <CardContent>
                            <p className="mt-3 text-sm">
                                {t("architectureEngineeringDescription")}
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="group border-0 shadow-none">
                        <CardHeader className="pb-3">
                            ...
                            <h3 className="mt-6 font-medium">{t("openMarketWorkflow")}</h3>
                        </CardHeader>
                        <CardContent>
                            <p className="mt-3 text-sm">
                                {t("openMarketWorkflowDescription")}
                            </p>
                        </CardContent>
                    </Card>
                </div>
