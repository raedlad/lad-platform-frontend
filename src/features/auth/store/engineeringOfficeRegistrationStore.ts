...
interface EngineeringOfficeRegistrationStore
  extends EngineeringOfficeRegistrationState {
  setCurrentStep: (step: EngineeringOfficeRegistrationStep) => void;
  ...
  getStoreState: () => EngineeringOfficeRegistrationState;
}

export const useEngineeringOfficeRegistrationStore =
  create<EngineeringOfficeRegistrationStore>((set, get) => ({
    ...
    getCurrentStepInfo: () => {
      const { currentStep } = get();
      const steps: EngineeringOfficeRegistrationStep[] = [
        "authMethod",
        "personalInfo",
        "verification",
        "technicalOperationalInfo",
