...
const SupplierOperationalCommercialInfoStep: React.FC = () => {
                      ...
                      <FormControl>
                        <FileUpload
                          ...
                          onChange={(files) => {
                            ...
                            form.setValue("supportingDocuments", files as File[]);
                          }}
                          multiple={true}
                        />
                      </FormControl>
...
export default SupplierOperationalCommercialInfoStep;
