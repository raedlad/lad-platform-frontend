...
const EngineeringOfficePlanSelectionStep: React.FC = () => {
  const store = useAuthStore();
  const { goToPreviousStep } = useEngineeringOfficeRegistration();
...
export default EngineeringOfficePlanSelectionStep;
