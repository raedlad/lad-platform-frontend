...
const EngineeringOfficeTechnicalOperationalInfoStep: React.FC = () => {
          ...
          <Form {...form}>
            ...
            >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-4">
                    <FormLabel className="font-bold text-[18px]">{FORM_LABELS.officeSpecializations}</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-4">
                    <FormLabel className="font-bold text-[18px]">{FORM_LABELS.yearsOfExperience}</FormLabel>
                    <Select
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-4">
                    <FormLabel className="font-bold text-[18px]">{FORM_LABELS.numberOfEmployees}</FormLabel>
                    <Select
                      onValueChange={field.onChange}
                      value={field.value}
                      disabled={isLoading}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-4">
                    <FormLabel className="font-bold text-[18px]">{FORM_LABELS.annualProjectVolume}</FormLabel>
                    <Select
                      onValueChange={field.onChange}
                      value={field.value}
                      disabled={isLoading}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-4">
                    <FormLabel className="font-bold text-[18px]">{FORM_LABELS.geographicCoverage}</FormLabel>
                    <FormControl>
                      <div className="grid grid-cols-1 gap-3">
              ...
              {form.watch("officialAccreditations") && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col gap-4">
                      <FormLabel className="font-bold text-[18px]">{FORM_LABELS.accreditationDocument}</FormLabel>
                      <FormControl>
                        <FileUpload
                          accept={[
                            "application/pdf",
...
export default EngineeringOfficeTechnicalOperationalInfoStep;
