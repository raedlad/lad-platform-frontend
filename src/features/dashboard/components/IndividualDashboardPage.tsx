    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-4 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          {/* Individual-specific Main Content */}
          <div className="lg:col-span-3">
            <IndividualSection
              projects={dashboardData?.recentProjects || []}
              offers={dashboardData?.recentOffers || []}
              onCreateProject={() =>
                handleNavigation("/dashboard/individual/projects/new")
              }
              onViewProject={(id) =>
                handleNavigation(`/dashboard/individual/projects/${id}`)
              }
              onViewOffer={(id) =>
                handleNavigation(`/dashboard/individual/offers/${id}`)
              }
            />
          </div>
          ...
          <div className="space-y-6">
            ...
            {upcomingEvents.length > 0 && (
              <CalendarWidget
                ...
                onViewAll={() => router.push("/dashboard/individual/calendar")}
              />
            )}
          </div>
        </div>
