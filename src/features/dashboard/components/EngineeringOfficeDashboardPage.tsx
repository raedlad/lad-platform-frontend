...
export function EngineeringOfficeDashboardPage() {
  ...
  const handleCompleteProfile = () => {
    router.push("/dashboard/engineering_office/profile");
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-4 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          {/* Engineering Office-specific Main Content */}
          <div className="lg:col-span-3">
            <EngineeringOfficeSection
              designProjects={[]}
              teamMembers={[]}
              onViewProject={(id) =>
                handleNavigation(`/dashboard/engineering_office/projects/${id}`)
              }
              onViewTeam={() =>
                handleNavigation("/dashboard/engineering_office/team")
              }
              onViewAllProjects={() =>
                handleNavigation("/dashboard/engineering_office/projects")
              }
            />
          </div>
          ...
          <div className="space-y-6">
            ...
            {upcomingEvents.length > 0 && (
              <CalendarWidget
                ...
                onViewAll={() =>
                  router.push("/dashboard/engineering_office/calendar")
                }
              />
            )}
          </div>
